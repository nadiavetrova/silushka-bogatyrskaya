  ...
  return (
    <div>
      ...
      <div className="space-y-2 mb-8">
        ...
        {[
          {
            title: "Как подобрать начальную «тягу» (вес)",
            content: [
              "Начни с «малого камня»: в начале пути выбирай вес, который кажется «лёгким пером». Цель — освоить правильное движение, будто воин, оттачивающий удар мечом.",
              "Правило 6-12 «взмахов»: для упражнений на силу выбирай такую «тягу», с которой сможешь сделать от 6 до 12 чистых и сильных «взмахов». Если можешь сделать более 12 легко — «камень» слишком лёгок. Если и 6 даются с трудом — слишком велик.",
              "Внимай телу своему: если чувствуешь острую боль (не путай с приятной усталостью после битвы), немедленно уменьши «тягу» или остановись. Мудрость воина — не идти напролом.",
              "Постепенный рост силы: когда «тяга» покажется «лёгким пером» и ты уверенно делаешь нужное количество «взмахов», увеличивай её на 5-10%. Так силушка будет расти, как дуб могучий.",
            ],
          },
          {
            title: "Наставления по технике и безопасности",
            content: [
              "Изучи «устав» движения: прежде чем браться за «тягу», изучи, как правильно выполняется каждый «богатырский приём». Правильная техника — основа силы и защита от недугов.",
              "Двигайся плавно и подконтрольно: выполняй упражнения, будто плавно, но мощно рубишь дерево. Избегай рывков и инерции. Сила в контроле.",
              "Вдыхай и выдыхай с силой: вдыхай, когда готовишься к усилию, и выдыхай, когда прилагаешь силу, будто издаёшь боевой клич.",
              "Одеяние и обувь воина: носи удобную одежду, не стесняющую движений, и крепкую обувь, дающую устойчивость, как корни могучего дерева.",
              "Не забывай про отдых: дай мышцам время на восстановление, словно воин, отдыхающий между битвами. Перегрузка может ослабить тебя.",
              "Призови соратника: для упражнений с большой «тягой» проси помощи у верного соратника, который подстрахует тебя.",
            ],
          },
          {
            title: "Правила «разминки» (подготовки к бою)",
            content: [
              "Общая подготовка (5-10 минут): начни с лёгких движений — быстрая ходьба, лёгкий бег, прыжки, будто разминаешься перед дальней дорогой. Цель — разогреть тело и подготовить кровь к богатырским свершениям.",
              "Динамические упражнения (5-10 минут): махи руками и ногами, вращения суставами — как разминка перед битвой. Избегай долгого статического растягивания перед силовой тренировкой — оно может временно ослабить силу.",
              "Специальная подготовка: прежде чем браться за максимальный вес, сделай несколько лёгких подходов с меньшей «тягой», чтобы «почувствовать» движение и подготовить тело к подвигу.",
            ],
          },
          {
            title: "Как понять: легко, средне или тяжело?",
            content: [
              "«Лёгкое перо» (Л): ты можешь выполнить все «взмахи» с запасом силы. Чувствуешь, что мог бы сделать ещё 3-5. Можешь легко вести разговор, пока делаешь упражнение.",
              "«Крепкий щит» (С): ты выполняешь «взмахи» с усилием. Последние 1-2 даются с трудом, но техника остаётся правильной. Мог бы сделать ещё 1-2.",
              "«Меч богатыря» (Т): ты выполняешь «взмахи» на пределе сил. Последние даются с огромным трудом, техника может страдать. Этот уровень для опытных воинов и требует осторожности.",
            ],
          },
          {
            title: "Кнопки Л / С / Т — зачем они нужны?",
            content: [
              "После каждого подхода ОБЯЗАТЕЛЬНО нажми одну из кнопок: Л (легко), С (средне) или Т (тяжело).",
              "Без этих пометок приложение НЕ СМОЖЕТ рассчитать рекомендации по весу и повторениям для следующей тренировки!",
              "Л (Легко) — подход дался без особого труда, ты мог бы сделать ещё несколько повторений. Приложение предложит прибавить вес или повторения.",
              "С (Средне) — подход дался с усилием, последние повторения потребовали концентрации. Приложение предложит повторить тот же вес.",
              "Т (Тяжело) — подход дался на пределе, техника начала страдать. Приложение предложит снизить вес на следующую тренировку.",
              "Нажимай кнопку сразу после подхода, пока ощущения свежи. Это ключ к твоему прогрессу!",
            ],
          },
        ].map((tip, idx) => (
