      ...
      <div className="space-y-2 mb-8">
        ...
        {[
          ...
          },
          {
            ...
            content: [
              "Легко (Л): ты выполнил все повторения с запасом силы. Чувствуешь, что мог бы сделать ещё 3-5. Можешь легко вести разговор во время упражнения.",
              "Средне (С): ты выполняешь повторения с усилием. Последние 1-2 даются с трудом, но техника остаётся правильной. Чувствуешь усталость, но не изнеможение.",
              "Тяжело (Т): ты выполняешь повторения на пределе сил. Последние даются с огромным трудом, техника может страдать. Этот уровень требует особой осторожности.",
            ],
          },
          {
